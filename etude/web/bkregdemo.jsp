<%-- 
    Document   : bkregdemo
    Created on : Mar 14, 2013, 11:58:36 PM
    Author     : Shajeer
--%>
...
<body onload="b_id.focus()">
        <form id="bk_reg_form" action="" method="post">

            <div id="front">
                <table width="500" align="center" cellpadding="10" cellspacing="3" class="outertable">
                    <tr>
...
%>
                    <tr>
                        <td><table width="100%" border="0" cellpadding="15" cellspacing="5" class="innertable">
                                <tr>
                                    <%
String dptname=dpt.getValue();                                    
%>
                                    <td> Department : </td>
                                    <td> 
                                        <select class="textbox" name="dpt"><option><%=dptname%></option></select>
                                    </td>
                                ...
                                <tr>
                                    <td> Type : </td>
                                    <td> 
                                        <input name="b_id2" type="text" class="textbox" id="b_id2" />
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td> Cost : </td>
                                    <td> 
                                        <input name="b_id3" type="text" class="textbox" id="b_id3" />
                                    </td>
                                </tr>
                                <tr>
                                    <td> Status : </td>
