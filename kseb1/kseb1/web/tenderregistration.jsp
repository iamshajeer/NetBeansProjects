...
WELCOME TO E PROCUREMENT FOR KSEB</a>
 ...
 <span>ADMIN</span>
        ...
        <% if(request.getParameter("success").equals("true"))
                ...
                out.println("suceessfully registered");
                
        %>
    <form action="savetender.jsp" id="formID" class="formular" >
      
    <fieldset >
        <legend>Fill tender details
        </legend>
TENDER_ID<input type="text" name="tid"/>

PRODUCT NAME<input type="text" name="tname"/>





PRODUCT NAME<input type="text" name="pdtname"/>
...
START DATE<input type="date" name="startdates"/>


CLOSE DATE<input type="date" name="closedate"/>


TENDER DESCRIPTION<textarea name="description"> </textarea>
