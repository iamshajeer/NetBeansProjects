 ...
 * @author prabeesh
 */
@WebServlet(name = "ScanServ", urlPatterns = {"/ScanServ"})
public class ScanServ extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       ScanTest scan = new ScanTest(regid, scanname, scanname, remark1, remark2, remark3);
        s.save(scan);
        tr.commit();
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ScanServ</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ScanServ at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {            
            out.close();
