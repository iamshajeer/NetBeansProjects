                    ...
                    <div id="main">
                        ...
                        <div id="left">		
                            <div class="left_box">
                                ...
                                <form action="pharmnew/delmed.jsp">

                                    <p>&nbsp;</p>
                                    <p>Delete Medicine</p>
                                    <p>&nbsp;</p>
                                    <table width="469" height="91" border="2" cellpadding="2">
                                        <tr>
                                            <td width="192" height="35">Medicine Name</td>
                                            <td width="255">
                                                <%Medicine m=null;%>
                                                <select style="width:200px;height: 26px" name="medname">
                                                ...
                                                <tr><td height="46">
                                                    ...
                                                    <td><input type="button" name="Reset" value="Reset" /></td></tr>
