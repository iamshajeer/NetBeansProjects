    ...
    <div id="content">
        <div id="back">
            ...
            <div id="header"> 
                ...
                <div id="menu">
                    <ul>
                        <li id="button1"> <a href="homemain.jsp"  title="">Home</a></li>

                        <li id="button4"><a href="aboutus.jsp"title="">About</a></li>
            ...
            <div id="main">
                ...
                <div id="left">		
                    <div class="left_box">
                        ...
                        <p><h2> Add medicine</h2></p>
                        <form action="pharmnew/addmed.jsp">
                            <table width="442" height="208" border="2" cellpadding="2">
                                <tr>
                                    <td width="171">Medicine Name</td>
                                    <td width="301"><label for="mname"></label>
                                        <input type="text" name="mname" id="mname" /></td>
                                </tr>
                                <tr>
                                    <td>Number of medicine</td>
                                    <td><label for="medno"></label>
                                        <input type="text" name="medno" id="medno" /></td>
                                </tr>
                                <tr>
                                    <td>Expairy date</td><td>
                                        <input type="date" name="edate" /></td></tr> 
                                <tr>
                                    <td>price</td>
                                ...
                                <tr>
                                    <td><input name="submit" name="ok" type="submit" value="submit" /></td>
                                    <td><input type="button" name="Reset" onclick="reset();" value="Reset" /></td>
                                </tr>
                            </table>
                        </form>
